...
export default function Home() {
  return (
    <div className=' font-[Open sans] bg-gradient-to-t from-[#000000] to-[#3D0000] ' id='home'>
   <div className=' relative z-10'>
   <SideBar/>
   </div>
   <div className=' flex flex-col justify-center items-center pb-28 '>
   <div className=' text-xl text-center font-[Bebas Neue] pt-24 text-red-400 font-bold tracking-[0.9rem] outline-8 pb-10 '>GymUpp</div>
    <div className="text-5xl lg:text-7xl text-center text-gray-500 ">Get Your Best</div>
