...
export default function Home() {
  return (
    <div className=' font-[Open sans] bg-gradient-to-t from-[#000000] to-[#3D0000] h-screen '>
   <div className=' relative z-10'>
   <SideBar/>
   </div>
   <div className=' flex flex-col justify-center items-center '>
   <div className=' text-xl text-center font-[Bebas Neue] pt-16 text-red-400 font-bold tracking-[0.9rem] outline-8 '>GymUpp</div>
