  ...
  return (
    ...
    <div className='lg:flex lg:justify-between mt-16 lg:mt-20 gap-5'>
      <div className=' '>
          ...
          <button className=' bg-[#3D0000] px-5 py-2 text-white text-lg rounded-full hover:bg-[#da1010] ml-[105px] lg:ml-0 my-6 m'> Workouts </button>
      </div>
    ...
    <div className='lg:flex lg:justify-between mt-16 lg:mt-20 gap-10'>
      ...
      <div className=' '>
          ...
          <button className=' bg-[#3D0000] px-5 py-2 text-white text-lg rounded-full hover:bg-[#da1010] ml-[105px] lg:ml-[570px] my-6 m'> Get Diet </button>
      </div>
    </div>
    </div>
